...
const services = [
  { title: "General & Private Contracting", image: assets.heroImg},
  { title: "Public Cleaning Services", image: assets.heroImg },
  { title: "Commercial Agencies", image:assets.heroImg },
];
  ...
  return (
    <section className="w-full h-screen"> {/* Full section height */}
      <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-6 h-full">
        ...
        <ServiceCardOverlay {...services[1]} className="h-full" />
        <ServiceCardOverlay {...services[2]} className="h-full" />
      </div>
    </section>
  );
}